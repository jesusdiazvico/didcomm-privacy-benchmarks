...
"results.merge-a-auth" u 1:2:3 with errorlines lw 2 pt 4 ps 2 linecolor rgb "orange" title "merge-a-auth", \
"results.ra-anon" u 1:2:3 with errorlines lw 2 pt 5 ps 2 linecolor rgb "black" title "ra-anon", \
"results.ra-a-auth" u 1:2:3 with errorlines lw 2 pt 6 ps 2 linecolor rgb "purple" title "ra-a-auth"
